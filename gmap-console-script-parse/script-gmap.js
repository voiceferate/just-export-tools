...
import('https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js').then(({ test }) => {
  ...
  $('.Nv2PK.THOPZb').each(function(){
    ...
    let company_activity = $(this).find('.Z8fK3b .W4Efsd .W4Efsd:nth-child(2) span:first-child jsl span:nth-child(2)').text().replace(/,/g, ".")
    let company_address =  $(this).find('.Z8fK3b .W4Efsd .W4Efsd:nth-child(2) span:nth-child(2) jsl span:nth-child(2)').text().replace(/,/g, ".")
    let phone =            $(this).find('.Z8fK3b .W4Efsd .W4Efsd:nth-child(3) span:nth-child(2) jsl span:nth-child(2)').text().replace(/,/g, ".")
